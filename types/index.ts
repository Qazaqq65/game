...
export interface WordDef {
  ...
  puzzleTitle?: string;
  /**
   * Сан бөлімі: ойын үстінде «не істеу керек» қысқа нұсқауы (тек ойын экраны).
   */
  ...
  /**
   * «Сандармен танысу» сияқты ұзын пазл: scatter плиткаларын N-лік топтармен
   * кезек-кезек шығару (алдыңғы топ толық орналасқан соң келесі).
   */
  digitIntroWaveSize?: number;
  /**
  ...
  /**
   * hideSlotGlyph=true кезінде: карман ішінде әлсіз «көмек» цифрасы (мысалы «Сандар реті»).
   */
  slotGlyphFaintHint?: boolean;
  /**
   * Пішіндер бөлімі: арнайы экран (классикалық пазл орнына).
